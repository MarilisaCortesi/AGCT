 ...
 */
interface CodingReaction<out C : TranscribingEntity, out T : TranscribableEntity> :
    Reaction {
    val coder: C
    val target: T
    val basalRate: Rate
 ...
 */
interface Transcription<out T : TranscribableEntity> :
    CodingReaction<Gene, T>

/**
 * The translation of a [protein][target] from a molecule of [mRNA][coder].
 */
interface Translation :
    CodingReaction<MRna, Protein>
