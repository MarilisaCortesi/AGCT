...
/*
    Create circuit "My Circuit" containing {
        The gene "gA" that {
            ...
            [codesFor] /.invoke/ [the] (protein) "pA" (that) {
                [has] (an) [initialConcentration] (of/in) ...
                [has] (a) [degradationRate] (of/in) ...
            } with {
                [a] /.invoke/ [basalRate] (in/of) ...

                [as] (regulator) [the] (molecule) "rA" that {
                    [has] (an) [initialConcentration] (of/in) ...
                    [has] (a) [degradationRate] (of/in) ...
                } with {
                    [a] /.invoke/ [regulatedRate] (in/of) ...
                    [a] /.invoke/ [bindingRate] (in/of) ...
                    [an] /.invoke/ [unbindingRate] (in/of) ...
                }
            }
        }
    }
